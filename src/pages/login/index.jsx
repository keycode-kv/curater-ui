...
const LoginPage = () => {
  ...
  const { loading:loginSuccess, run:handleLogin } = useRequest(login, {
    manual: true,
    onSuccess: result => {
  ...
  const { loading:signupSuccess, run:handleSignup } = useRequest(signUp, {
    manual: true,
    onSuccess: result => {
        ...
        <Paper elevation={3} className={classes.paper}>
          <form className={classes.form}>
            <div className={classes.buttonContainer}>
              <Button
                variant='text'
                className={selected === 'login' ? classes.selectedButton : classes.unSelectedButton}
              ...
              <Button
                variant='text'
                className={selected === 'signup' ? classes.selectedButton : classes.unSelectedButton}
            ...
            />
            {showEmailError && <ValidationMessage message="Email is required." />}
            {selected === 'signup' && <TextField
              placeholder="Name"
              variant="outlined"
              className={classes.textField}
              value={name}
            ...
            />}
            {selected==='signup' && showNameError && <ValidationMessage message="Name is required." />}
            <TextField
            ...
            />
            {showPasswordError && <ValidationMessage message="Password is required." />}
            <Button
              variant="contained"
